...
Having two copies (one local, one remote) without versionning is sufficient in term of backups for the documents I have on my Windows machine (I put them on my Linux machine via SAMBA if they're important).
